...
#include "../../include/variables/CEMOEulerVariable.hpp"
#include <cmath>

CEMOEulerVariable::CEMOEulerVariable(su2double val_pressure,
...
void CEMOEulerVariable::SetVelocity2(unsigned long iPoint) {
...
bool CEMOEulerVariable::SetPrimVar(unsigned long iPoint, CFluidModel *FluidModel) {

  unsigned short iVar;

  fluidmodel = static_cast<CEMOGas*>(FluidModel);
...
bool CEMOEulerVariable::Cons2PrimVar(su2double *U, su2double *V,
