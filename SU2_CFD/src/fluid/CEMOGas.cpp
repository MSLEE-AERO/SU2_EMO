/*!
 * \file CEMOGas.cpp
 * \brief Source of the Equilibrium gas model.
...
#include "../../include/fluid/CEMOGas.hpp"
#include "../../../Common/include/toolboxes/geometry_toolbox.hpp"

CEMOGas::CEMOGas(const CConfig* config, unsigned short val_nDim): CFluidModel(){
...
void CEMOGas::SetTDStatePTTv(su2double val_pressure, const su2double *val_massfrac,
