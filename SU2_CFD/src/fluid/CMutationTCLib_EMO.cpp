/*!
 * \file CMutationTCLib_EMO.cpp
 * \brief Source of the Mutation++ Equilibrium gas model.
 * \author C. Garbacz
...
#include "../../include/fluid/CMutationTCLib_EMO.hpp"

CMutationTCLib_EMO::CMutationTCLib_EMO(const CConfig* config, unsigned short val_nDim): CEMOGas(config, val_nDim){
...
CMutationTCLib_EMO::~CMutationTCLib_EMO(){}

// rename functino name!! todo! minsul
void CMutationTCLib_EMO::SetTDStateRhosTTv(vector<su2double>& val_rhos, su2double val_temperature, su2double val_temperature_ve){
