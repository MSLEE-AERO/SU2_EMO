/*!
 * \file CEMOGas.hpp
 * \brief Defines the Equilibrium gas model.
...
/*!
 * \class CEMOGas
 * \brief Class for defining the Equilibrium gas model.
 * \author: C. Garbacz, W. Maier, S. R. Copeland
 */
class CEMOGas : public CFluidModel {
...
protected:
  ...
  nEnergyEq = 1;                         /*!< \brief Number of energy equations for the Eq. model. */
...
public:
   ...
   */
  CEMOGas(const CConfig* config, unsigned short val_nDim);
