/*!
 * \file CEMOEulerVariable.hpp
 * \brief Class for defining the variables of the compressible EMO Euler solver.
...
/*!
 * \class CEMOEulerVariable
 * \brief Main class for defining the variables of the EMO Euler's solver.
 ...
 */
class CEMOEulerVariable : public CFlowVariable {
 public:
 ...
 protected:
  ...
  /*!< \brief Index definition for EMO pritimive variables. */
 ...
 public:
   ...
   */
  CEMOEulerVariable(su2double val_pressure, const su2double *val_massfrac,
