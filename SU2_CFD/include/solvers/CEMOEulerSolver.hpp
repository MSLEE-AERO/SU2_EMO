/*!
 * \file CEMOEulerSolver.hpp
 * \brief Headers of the CEMOEulerSolver class
...
#include "../variables/CEMOEulerVariable.hpp"
#include "../fluid/CEMOGas.hpp"
#include "CFVMFlowSolverBase.hpp"

/*!
 * \class CEMOEulerSolver
 * \brief Main class for defining the NEMO Euler's flow solver.
 * \ingroup Euler_Equations
 * \author S. R. Copeland, F. Palacios, W. Maier.
 * \version 8.5.0 "Harrier"
 */
class CEMOEulerSolver : public CFVMFlowSolverBase<CEMOEulerVariable, ENUM_REGIME::COMPRESSIBLE> {
protected:
...
public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CEMOEulerSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh, const bool navier_stokes = false);

  /*!
   * \brief Destructor of the class.
   */
  ~CEMOEulerSolver(void) override;
   ...
   */
  inline CEMOGas* GetFluidModel(void) const final { return FluidModel;}
